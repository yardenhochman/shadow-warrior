        ...
        while True:
            try:
                ...
                if game_state == "breath":
                    ...
                    #pixels2.fill((int(255 * (new_audio_level / MAX_AUDIO_LEVEL) * 0.5),0, int(255 * (new_acceleration / MAX_ACCELERATION_LEVEL))))
            ...
            while True:
                ...
                if game_state == "breath":
                    if audio_level > breath_audio_threshold:
                        ...
                        logging.info("Detected sound but not strong enough " + str(audio_level))
                ...
                if game_state == "shout" and audio_level > shout_threshold:
